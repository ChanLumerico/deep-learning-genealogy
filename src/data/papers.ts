...
export const PAPERS: Record<string, string> = {
  ...
  selfforce: 'Self Forcing: Bridging the Train-Test Gap in Autoregressive Video Diffusion',
  motionstream: 'MotionStream: Real-Time Video Generation with Interactive Motion Controls',
  versecrafter: 'VerseCrafter: Dynamic Realistic Video World Model with 4D Geometric Control',
